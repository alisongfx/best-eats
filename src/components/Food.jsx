...
const Food = () => {
    ...
    //Filter type burguers/pizza/etc
        ...
        <div className='max-w-[1640px] m-auto px-4 py-12'>
            ...
            <div className='flex flex-col lg:flex-row justify-between'>
                ...
                <div>
                    ...
                    <div className='flex gap-2 justify-between max-w-[390px] w-full'>
            ...
            <div className='grid grid-cols-2 lg:grid-cols-4 gap-6 pt-4'>
                {foods.map((item, index) => (
                    <div key={index} className='border shadow-lg rounded-lg hover:scale-105 duration-300 ease-in-out'>
